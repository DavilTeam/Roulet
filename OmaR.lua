...
return {
Lock     = '[- OmaR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/OmaR)\n*— — — — — — — — —\n★︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n★︙خاصيه المسح *',
unLock   = '[- OmaR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/OmaR)\n*— — — — — — — — —\n★︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- OmaR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/OmaR)\n*— — — — — — — — —\n★︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n★︙خاصيه الكتم *',
lockKid  = '[- OmaR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/OmaR)\n*— — — — — — — — —\n★︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n★︙خاصيه التقييد *',
lockKick = '[- OmaR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/OmaR)\n*— — — — — — — — —\n★︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n★︙خاصيه الطرد *',
Reply    = '[- OmaR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/OmaR)\n*— — — — — — — — —\n★︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheOmaR.."OmaR:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ★' then   
Redis:del(TheOmaR.."OmaR:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheOmaR..'OmaR:GetTexting:DevTheOmaR'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ★' then 
Redis:del(TheOmaR..'OmaR:GetTexting:DevTheOmaR'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'★︙تم الغاء حفظ كليشة المطور')
end
Redis:set(TheOmaR..'OmaR:Texting:DevTheOmaR',text)
Redis:del(TheOmaR..'OmaR:GetTexting:DevTheOmaR'..msg_chat_id..':'..msg.sender.user_id)
...
download( 'http://october3.ml/SORASOmaR/OmaR.lua','Snabir.lua')
...
{{text = '✫ OmaR 𝖲OURCE ',url="t.me/OmaR"}},
}
...
{
{text = '✫ OmaR 𝖲OURCE ', url = "https://t.me/OmaR"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/remixsource/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == "صوره" or text == "صوره" then 
Abs = math.random(2,140); 
local Text ='*✫︙تم اختيار انمي لك*'
keyboardd = {} 
keyboardd.inline_keyboard = {
...
data = {
{
{text = '- قناة السورس', url = 't.me/OmaR'}, 
},
}
}
...
if text == (Redis:get(TheOmaR.."OmaR:Name:Bot") or "سنايبر") then
local NamesBot = (Redis:get(TheOmaR.."OmaR:Name:Bot") or "سنايبر")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
Redis:set(TheOmaR.."OmaR:Get:Reides:Commands:Group"..msg_chat_id..":"..'مك','مسح المكتومين')
...
Redis:set(TheOmaR.."OmaR:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثا','رفع مطور ثانوي')
Redis:set(TheOmaR.."OmaR:Get:Reides:Commands:Group"..msg_chat_id..":"..'.','غنيلي')
...
local CmdStart = '*\n★︙أهلآ بك في بوت '..(Redis:get(TheOmaR.."OmaR:Name:Bot") or "سنايبر")..
